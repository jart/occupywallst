...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'UserInfo.karma'
        db.add_column('occupywallst_userinfo', 'karma', self.gf('django.db.models.fields.IntegerField')(default=0), keep_default=False)

        # Changing field 'Article.published'
        db.alter_column('occupywallst_article', 'published', self.gf('django.db.models.fields.DateTimeField')())


    def backwards(self, orm):
        
        # Deleting field 'UserInfo.karma'
        db.delete_column('occupywallst_userinfo', 'karma')

        # Changing field 'Article.published'
        db.alter_column('occupywallst_article', 'published', self.gf('django.db.models.fields.DateTimeField')(auto_now_add=True))
