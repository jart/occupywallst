...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'UserInfo.is_moderator'
        db.add_column('occupywallst_userinfo', 'is_moderator', self.gf('django.db.models.fields.BooleanField')(default=False), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'UserInfo.is_moderator'
        db.delete_column('occupywallst_userinfo', 'is_moderator')
